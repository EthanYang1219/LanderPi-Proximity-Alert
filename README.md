...
- [x] Re-integrate the I2C buzzer so it fires simultaneously with the obstacle-avoidance stop
- [x] Collect full trial sets across all five surfaces
- [x] Statistical analysis of slippage by surface (Haotian)
